XBOX NASM Demo Applications
Bryant Keller <bkeller@asmcommunity.net>
Keith Kanios <keith@asmcommunity.net>
Copyright (c) 2006-2007, Byrant Keller and Keith Kanios
All rights reserved.
 ...
 collection for the design of 32-bit XBOX applications.
 Below is a list of all current demonstration packages and
 their function.

  DEMO1  - Demonstrates how to print to the video buffer,
           waiting and returning to the dashboard.

 All of these applications, as well as the NASMX.INC file,
 were completely developed and designed by Bryant Keller
 and/or Keith Kanios. As such, all rights over these files
 belong to Bryant Keller and Keith Kanios. You are
 permitted to use these demonstration applications and the
 NASMX.INC file as you see fit, so long as any source
